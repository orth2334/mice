...
def create_report():
    ...
    formulas_data = [
        ...
        {
            "category": "⑨ 현지 교통 및 셔틀 운행 (Local Transportation - 가이드라인 제5장)",
            "target": "행사 목적지 도시 내 공항/역 ↔ 호텔, 호텔 ↔ 행사장 간 육상 이동 배출량 및 셔틀 전환 감축 산정",
            "formula": "• 5.1 측정 경계: 공항/역↔호텔, 호텔↔행사장 이동(연소+WTT 포함, 사적 우회/관광 제외)\n• 5.2 기본 가정: 1인 1일 왕복 25km, 전시회 1일/컨퍼런스 N일, 카풀 대당 1.5명\n• 수단 배분: 셔틀 제공 시(셔틀 50%, 택시 30%, 대중교통 20%) / 셔틀 미제공 시(택시 50%, 대중교통 50%)\n• 5.3 산정 공식:\n  - 연소 공식 1: 이동거리(km) × 배출계수(kgCO2e/km)\n  - 연소 공식 2: 이동거리(km) × 승객수 × 배출계수(kgCO2e/p·km)\n  - 연소 공식 3: 연료소비량(L) × 배출계수(kgCO2e/L)\n  - WTT 상류 공식 1, 2, 3: 각 항목별 WTT 배출계수 적용",
            "meaning": "NZCE Cat 4/5 및 GHG Protocol Scope 3 현지 교통 가이드라인 5.1~5.3 표준 완벽 부합"
        }
    ]
